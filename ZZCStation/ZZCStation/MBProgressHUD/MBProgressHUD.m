...
//	label.adjustsFontSizeToFitWidth = NO;
	...
	detailsLabel.font = [UIFont systemFontOfSize:kLabelFontSize];
//	detailsLabel.adjustsFontSizeToFitWidth = NO;
	...
	detailsLabel.font = [UIFont systemFontOfSize:14.f];
...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    ...
    CGSize labelSize = [label.text sizeWithFont:[UIFont systemFontOfSize:kLabelFontSize]
                                            constrainedToSize:CGSizeMake(maxWidth-2 * kPadding, 0) lineBreakMode:detailsLabel.lineBreakMode];
	...
	CGSize maxSize = CGSizeMake(maxWidth-2 * kPadding, remainingHeight);
	CGSize detailsLabelSize = [detailsLabel.text sizeWithFont:[UIFont systemFontOfSize:15.f]
